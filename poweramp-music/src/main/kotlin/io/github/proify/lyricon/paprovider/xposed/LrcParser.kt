...
package io.github.proify.lyricon.paprovider.xposed//package io.github.proify.lyricon.paprovider.xposed
//
...
//     * 解析 LRC 文本内容为结构化数据
//     */
//    fu vn parseLrcContent(raw: String?): List<RichLyricLine> {
